      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-white">
        ...
        <div className="text-center w-full mb-10">
          <h2 className="text-3xl font-extrabold tracking-tight mb-2">
            SAISAI<span className="text-main">.</span>
          </h2>
          <p className="text-md text-gray-600">책사이, 우리사이, 사이사이</p>
        </div>

        {/* Kakao Login */}
        <Button
          onClick={requestKakaoLogin}
          className="w-full bg-[#FEE500] text-[#000000] text-sm py-6 rounded-md hover:bg-[#FEE500]/90 transition font-medium"
        >
          카카오로 로그인
        </Button>
      </div>
